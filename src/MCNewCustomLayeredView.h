...
typedef enum {
    MCNewCustomLayeredViewImageBoundsFullRect,
    MCNewCustomLayeredViewImageBoundsItemRect
} MCNewCustomLayeredViewImageBoundsStyle;
 ...
 */
@property (nonatomic) MCNewCustomLayeredViewImageBoundsStyle imageBoundsStyle;
